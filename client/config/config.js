...
.config(function($stateProvider, $urlRouterProvider){
  ...
  .state('dashboard.user', {url: '/dashboard/{lastName}', templateUrl: '/views/users/user-dashboard.html', controller: 'AdminDashboardCtrl'})
  .state('dashboard.admin', {url: '/admin/dashboard', templateUrl: '/views/users/admin-dashboard.html', controller: 'UserDashboardCtrl'})
  ...
  .state('client.list', {url: '/clients', templateUrl: '/views/clients/client-list.html', controller: 'ClientCtrl'})
